...
public class VaccineCenter {
    ...
    public static void addPatienttoaBooth()
    {
        ...
        patientName = new Scanner(System.in).nextLine();
        vaccinationBoohts[boothNumbers-1] = patientName;
        nameofpatients.add(patientName);                   //add patient to the booth number above called
